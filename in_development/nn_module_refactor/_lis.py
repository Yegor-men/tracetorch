...
class LIS(nn.Module):
	def __init__(
		...
		self.mem_decay = nn.Parameter(tt.functional.sigmoid_inverse(torch.full((num_out,), mem_decay)))
		self.threshold = nn.Parameter(tt.functional.softplus_inverse(torch.full((num_out,), threshold)))
