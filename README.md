...
[![Documentation](https://img.shields.io/badge/Documentation-v0.16.0-red.svg)](https://yegor-men.github.io/tracetorch/)
[![License](https://img.shields.io/badge/License-MIT-purple.svg)](https://opensource.org/license/mit)
[![PyPI](https://img.shields.io/badge/PyPI-v0.16.0-blue.svg)](https://pypi.org/project/tracetorch/)
...
```bash
git clone --branch v0.16.0 https://github.com/Yegor-men/tracetorch
cd tracetorch
pip install -e .
```
